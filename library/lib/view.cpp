...
void View::drawHighlight(NVGcontext* vg, Theme theme, float alpha, Style style, bool background)
{
    ...
    this->getHighlightInsets(style, &insetTop, &insetRight, &insetBottom, &insetLeft);
...
void View::setBackgroundColor(NVGcolor color)
{
    this->backgroundColor = color;
    this->setBackground(ViewBackground::COLOR);
}
